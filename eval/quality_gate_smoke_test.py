...
def main() -> None:
    baseline = payload({"recall_at_5": 1.0, "precision_at_3": 0.3, "ndcg_at_5": 0.9, "mrr_at_10": 0.9, "negative_no_answer_rate": 0.5, "citation_coverage": 1.0, "extractive_citation_faithfulness": 1.0, "extractive_claim_faithfulness": 1.0, "answer_correctness": 1.0, "citation_correctness": 1.0, "citation_completeness": 1.0})
    acceptable = payload({"recall_at_5": 0.96, "precision_at_3": 0.27, "ndcg_at_5": 0.87, "mrr_at_10": 0.88, "negative_no_answer_rate": 0.48, "citation_coverage": 0.96, "extractive_citation_faithfulness": 0.96, "extractive_claim_faithfulness": 0.96, "answer_correctness": 0.96, "citation_correctness": 0.96, "citation_completeness": 0.96})
    assert not quality_gate.compare_metrics(baseline, acceptable, quality_gate.DEFAULT_MIN_DELTAS)

    regressed = payload({"recall_at_5": 0.9, "precision_at_3": 0.2, "ndcg_at_5": 0.7, "mrr_at_10": 0.8, "negative_no_answer_rate": 0.3, "citation_coverage": 0.8, "extractive_citation_faithfulness": 0.8, "extractive_claim_faithfulness": 0.8, "answer_correctness": 0.8, "citation_correctness": 0.8, "citation_completeness": 0.8})
    ...
    assert any("answer_correctness" in error for error in errors)
    assert any("citation_completeness" in error for error in errors)
